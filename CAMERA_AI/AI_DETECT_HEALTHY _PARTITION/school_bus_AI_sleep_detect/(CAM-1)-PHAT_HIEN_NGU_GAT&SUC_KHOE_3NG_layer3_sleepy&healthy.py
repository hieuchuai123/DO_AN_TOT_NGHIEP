...
READ_TIMEOUT      = 6.0
TARGET_FETCH_FPS  = 6
ESP32_IP = "172.20.10.7" # Hoặc IP ESP32 thật / IP server giả lập
...
class FaceMeshWorker:
    ...
    def health_score_from_metrics(self, seat_id, metrics, emotion): # Sửa tid -> seat_id
        ...
        emo_pen = {"Sad":12, "Fear":8, "Angry":6, "Surprise":0, "Neutral":0, "Happy":0, "Emotion:OFF":0}
        ...
        elif S_disp_new >= 45: health = "Met moi"
